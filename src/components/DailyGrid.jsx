          ...
          return (
            <article key={day.dt} className="flex flex-col items-center gap-2 rounded-2xl border border-white/30 bg-white/60 p-3 text-center shadow-sm backdrop-blur transition hover:-translate-y-0.5 hover:shadow-md dark:border-white/10 dark:bg-slate-800/50">
              ...
              <p className="text-sm font-semibold text-slate-700 dark:text-slate-200 flex items-center gap-2">
                <span className="inline-flex items-center gap-1 rounded-full bg-rose-100 px-2 py-0.5 text-rose-700 dark:bg-rose-400/20 dark:text-rose-200" title="High">
                  <span aria-hidden="true">H</span>
                  <span>{formatTemp(day.tempMax, units)}</span>
                </span>
                <span className="inline-flex items-center gap-1 rounded-full bg-sky-100 px-2 py-0.5 text-sky-700 dark:bg-sky-400/20 dark:text-sky-200" title="Low">
